...
var DateTimeShortcuts = {
    ...
    addCalendar: function(inp) {
        ...
        cal_nav.className = 'calendarnav-arrows';
        
        var cal_nav_prev = quickElement('a', cal_nav, '', 'href', 'javascript:DateTimeShortcuts.drawPrev('+num+');');
        cal_nav_prev.className = 'calendarnav-previous pull-left';

        var icon_left = quickElement('i', cal_nav_prev);
        icon_left.className = 'icon-arrow-left icon-white';
        
        var cal_nav_next = quickElement('a', cal_nav, '', 'href', 'javascript:DateTimeShortcuts.drawNext('+num+');');
        cal_nav_next.className = 'calendarnav-next pull-right';

        var icon_right = quickElement('i', cal_nav_next);
        icon_right.className = 'icon-arrow-right icon-white';
