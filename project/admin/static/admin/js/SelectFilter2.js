...
window.SelectFilter = {
    init: function(field_id, field_name, is_stacked, admin_media_prefix) {
        ...
        selector_available.className = 'selector-available well pull-left';
        var title_available = quickElement('h3', selector_available, interpolate(gettext('Available %s') + ' ', [field_name]));
        ...
        var filter_div = quickElement('div', filter_p);
        filter_div.className = 'input-prepend';
        ...
        var filter_prepend = quickElement('span', filter_div);
        filter_prepend.className = 'add-on';

        var filter_search = quickElement('i', filter_prepend);
        filter_search.className = 'icon-search';

        var filter_input = quickElement('input', filter_div, '', 'type', 'text', 'placeholder', gettext("Filter"));
        ...
        choose_all.className = 'selector-chooseall btn';

        // <ul class="selector-chooser">
        var selector_chooser = quickElement('ul', selector_div, '');
        selector_chooser.className = 'selector-chooser pull-left';
        ...
        add_link.className = 'selector-add btn';

        var icon_right = quickElement('i', add_link);
        icon_right.className = 'icon-arrow-right';
        ...
        remove_link.className = 'selector-remove btn';

        var icon_left = quickElement('i', remove_link);
        icon_left.className = 'icon-arrow-left';

        // <div class="selector-chosen">
        var selector_chosen = quickElement('div', selector_div, '');
        selector_chosen.className = 'selector-chosen well pull-left';
        var title_chosen = quickElement('h3', selector_chosen, interpolate(gettext('Chosen %s') + ' ', [field_name]));
        ...
        clear_all.className = 'selector-clearall btn';
